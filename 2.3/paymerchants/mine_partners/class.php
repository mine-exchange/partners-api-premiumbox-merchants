...
class AP_MinePartnersApi
{
    ...
    public function __construct($apiUrl, $apiAuthKey, $apiSignatureKey, $paymerchantId, $paymerchantName)
    {
        if (!empty($apiUrl)) {
    ...
    private function request($endpoint, $parameters = [], $method = 'GET')
    {
        ...
        do_action('save_paymerchant_error', $this->paymerchantName, $this->paymerchantId, $requestUri, $headers, $parameters, $response, $errors);
